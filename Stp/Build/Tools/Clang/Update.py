...
STP_DIR = os.path.abspath(os.path.join(THIS_DIR, '..', '..', '..'))
BUILD_TOOLS_DIR = os.path.join(STP_DIR, 'Build', 'Tools')
LLVM_DIR = os.path.join(BUILD_TOOLS_DIR, 'LLVM')
LLVM_BOOTSTRAP_DIR = os.path.join(BUILD_TOOLS_DIR, 'llvm-bootstrap')
LLVM_BOOTSTRAP_INSTALL_DIR = os.path.join(BUILD_TOOLS_DIR,
                                          'llvm-bootstrap-install')
LLVM_LTO_GOLD_PLUGIN_DIR = os.path.join(BUILD_TOOLS_DIR, 'llvm-lto-gold-plugin')
CHROME_TOOLS_SHIM_DIR = os.path.join(LLVM_DIR, 'tools', 'chrometools')
LLVM_BUILD_DIR = os.path.join(BUILD_TOOLS_DIR, 'LlvmBuild', 'Release+Asserts')
...
LLVM_BUILD_TOOLS_DIR = os.path.abspath(
    os.path.join(LLVM_DIR, '..', 'LlvmBuildTools'))
STAMP_FILE = os.path.normpath(
    os.path.join(LLVM_DIR, '..', 'LlvmBuild', 'cr_build_revision'))
BINUTILS_DIR = os.path.join(BUILD_TOOLS_DIR, 'binutils')
...
ANDROID_NDK_DIR = os.path.join(
    STP_DIR, 'third_party', 'android_tools', 'ndk')
...
def GetVSVersion():
  ...
  sys.path.append(os.path.join(STP_DIR, 'build'))
  import VsToolchain
  VsToolchain.SetEnvironmentAndGetRuntimeDllDirs()

  # Use gyp to find the MSVS installation, either in depot_tools as per above,
  # or a system-wide installation otherwise.
  sys.path.append(os.path.join(STP_DIR, 'tools', 'gyp', 'pylib'))
  import gyp.MSVSVersion
  vs_version = gyp.MSVSVersion.SelectVisualStudioVersion(
      VsToolchain.GetVisualStudioVersion())
  return vs_version
...
def UpdateClang(args):
  ...
  if not args.force_local_build:
    ...
    try:
      ...
      # builds on linux.
      if need_gold_plugin:
        RunCommand(['python', STP_DIR+'/build/download_gold_plugin.py'])
  ...
  cmake_args += base_cmake_args + [
      ...
      '-DCHROMIUM_TOOLS_SRC=%s' % os.path.join(STP_DIR, 'tools', 'clang'),
...
def main():
  ...
  if args.if_needed:
    ...
    # If you don't want this, delete Tools/LlvmBuild on your machine.
