...
def _DetectVisualStudioPath():
  ...
  # Use the code in Build/VsToolchain.py to avoid duplicating code.
  chromium_dir = os.path.abspath(os.path.join(SCRIPT_DIR, '..', '..', '..'))
  sys.path.append(os.path.join(chromium_dir, 'build'))
  import VsToolchain
  return VsToolchain.DetectVisualStudioPath()
...
def main():
  ...
  assert vc_bin_dir
  print 'vc_bin_dir = ' + GnHelpers.ToGNString(vc_bin_dir)
  assert include_I
  print 'include_flags_I = ' + GnHelpers.ToGNString(include_I)
  assert include_imsvc
  print 'include_flags_imsvc = ' + GnHelpers.ToGNString(include_imsvc)
