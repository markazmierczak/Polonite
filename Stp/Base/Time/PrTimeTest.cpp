...
PRTime comparison_time_pdt = 1192477500 * TimeDelta::MicrosecondsPerSecond;
...
class PRTimeTest : public testing::Test {
 protected:
  void SetUp() override {
    ...
    comparison_time_local_ = mktime(&local_comparison_tm) * TimeDelta::MicrosecondsPerSecond;
    ...
    comparison_time_local_2_ = mktime(&local_comparison_tm_2) * TimeDelta::MicrosecondsPerSecond;
